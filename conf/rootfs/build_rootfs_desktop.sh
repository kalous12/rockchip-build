...
function build_rootfs_hook__build_desktop() {
...
EOF
    ...
    cp ${overlay_dir}/etc/gdm3/greeter.dconf-defaults ${chroot_dir}/etc/gdm3/
    cp ${overlay_dir}/etc/gdm3/daemon.conf ${chroot_dir}/etc/gdm3/
